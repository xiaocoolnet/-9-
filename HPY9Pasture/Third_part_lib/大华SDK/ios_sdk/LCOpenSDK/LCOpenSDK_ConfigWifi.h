 ...
 *          -1, 接口调用失败
 */
-(NSInteger)configWifiStart:(NSString*)devId ssid:(NSString*)ssid password:(NSString*)pwd secure:(NSString*)security callback:(LCOpenSDK_ConfigWifiCallBack)funcPtr userData:(id)userData timeout:(NSInteger)timeout;
/**
 *  停止Wifi配网
 *
 *  @return  0, 接口调用成功
