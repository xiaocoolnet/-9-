//
//  AddMedicationMessagesViewController.swift
//  HPY9Pasture
//
...
class AddMedicationMessagesViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    let myTableView = UITableView()
    let textArray = ["序号","药物名称","用法用量","开始日期","结束日期","是否继续","备注"]
    ...
    func CreatDataPicker(){
        ...
        let date2 = dateFormatter.dateFromString("2100-01-01")
    ...
    func datePickerDetermineButtonAction(){
        ...
        self.showEffectView()
        if self.isbegin {
            self.lastText[3] = self.briDateString1
