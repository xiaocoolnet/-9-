//
//  AddPhysicalExaminationViewController.swift
//  HPY9Pasture
//
...
class AddPhysicalExaminationViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    let myTableView = UITableView()
    let textArray = ["序号","体检医院","体检类型","体检结果","体检时间","备注"]
